...
export default function HomepageReviews() {
  ...
  return (
    <section className="flex gap-[1.5rem] justify-center">
      ...
      {reviews.map((review) => {
        return (
          <div className="w-[25rem] border-slate-500 border-[.1rem] p-[1rem] rounded-xl bg-slate-700">
            {/* Review */}
            <div className="flex flex-col gap-[.5rem]">
              <div className="flex gap-[1rem]">
                ...
                />
                <div>
                  <h3 className="font-semibold text-[1.3rem]">
                    Abhishek kumar
                  </h3>
              ...
              <div>
                ...
                <p className="text-stone-300">
                  ...
                  amet voluptate quo odit explicabo et doloribus suscipit
                  asperiores placeat nisi!
                </p>
              </div>
            </div>
          </div>
